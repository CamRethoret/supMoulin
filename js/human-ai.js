...
jQuery(document).ready(function($) {
    ...
    function verifSuite(joueur, a, b, c){
        ...
        if((x.hasClass("j"+joueur) && y.hasClass("j"+joueur)) && !z.hasClass("j"+joueur)){
            console.log('Il faut placer un pion en '+c);
            return c;
        }
        else if((x.hasClass("j"+joueur) && !y.hasClass("j"+joueur)) && z.hasClass("j"+joueur))  {
    ...
    function actionAIPremier(){
        ...
        for(var i=0; i<16; i++){
            ...
            if(blocMoulin==a || blocMoulin==b || blocMoulin==c){
                console.log('L\'AI a vue que l\' peut faire un moulin et décide d\'ajouter un pion en '+blocMoulin);
